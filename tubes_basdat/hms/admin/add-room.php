...
$sql=mysqli_query($con,"insert into ruangan(id_ruangan,nama_ruangan,kapasitas,jenis) values('$roomid','$roomname','$roomcap','$roomclass')");
if($sql)
{
...
<div class="form-group">
					...
					<input type="text" name="roomname" class="form-control"  placeholder="Enter Room Name" required="true">
														</div>
...
<div class="form-group">
					...
					<input type="text" name="roomcap" class="form-control"  placeholder="Enter Room Capacity" required="true"></input>
														</div>
<div class="form-group">
															<label for="fess">
																 Room Class
															</label>
					<input type="text" name="roomclass" class="form-control"  placeholder="Enter Room Class" required="true">
														</div>
