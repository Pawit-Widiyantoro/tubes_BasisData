            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-2 col-md-3  col-sm-12" style="color:#000;font-weight:bold; font-size:42px; margin-top: 1% !important;">HMS
                       <a data-toggle="collapse" data-target="#menu" href="#" ><i class="fas d-block d-md-none small-menu fa-bars"></i></a>
                    </div>
                    <div id="menu" class="col-lg-8 col-md-9 d-none d-md-block nav-item">
                        <ul>
                            ...
                            <li><a href="hms/admin" class="btn btn-success" >Login</a></li>  
                        </ul>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-12">
                    ...
                    <ul class="list-unstyled link-list">
                        ...
                        <li><a ui-sref="products" href="#">Logins</a><i class="fa fa-angle-right"></i></li>
